- **Plugin context:** Obsidian plugin _Canvas Link to Group_.
- **Goal:** fix aliased link handling; later, implement auto‑update of links on group rename.
- bug in Canvas link to group: if I add an alias name to the link, link breaks
